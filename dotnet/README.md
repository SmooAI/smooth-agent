...
C#/.NET protocol types and a native WebSocket client for the **smooth-agent**
...
```bash
dotnet build SmooAI.SmoothAgent.slnx
dotnet test  SmooAI.SmoothAgent.slnx
```
