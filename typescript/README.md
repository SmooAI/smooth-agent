...
TypeScript protocol types and a native WebSocket client for the **smooth-agent**
...
```ts
import { SmoothAgentClient } from '@smooai/smooth-agent';
...
```ts
import { ProtocolValidator } from '@smooai/smooth-agent';
