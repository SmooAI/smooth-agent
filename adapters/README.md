...
- `dynamodb/` — AWS serverless path. ElectroDB single-table for conversation/participant/message/session/checkpoint + **Amazon S3 Vectors** for knowledge embeddings.
