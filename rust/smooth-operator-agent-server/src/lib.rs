//! # smooth-operator-agent-server
//!
//! The reference WebSocket service for smooth-operator-agent. It speaks the
//! schema-driven protocol in `smooth-operator-agent/spec/` over a smooth-operator-backed
...
//!   smooth-operator [`Agent`](smooth_operator::Agent).
