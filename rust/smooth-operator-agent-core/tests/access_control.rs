...
use smooth_operator_agent_core::access_control::{AccessContext, AclKnowledgeStore, DocAcl};
...
fn seeded_store() -> AclKnowledgeStore {
    ...
    let store = AclKnowledgeStore::new(Arc::new(smooth_operator::InMemoryKnowledge::new()));
