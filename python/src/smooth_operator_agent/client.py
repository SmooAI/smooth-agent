...
* **Transport-agnostic.** The client never touches a real socket directly; it talks
  to an injectable :class:`~smooth_operator_agent.transport.Transport`. The default
  (:class:`~smooth_operator_agent.transport.WebSocketTransport`) uses `websockets`; tests
