...
Tracked against the [ROADMAP](ROADMAP.md); these become Phase 4 (tools/ingestion), Phase 6 (deploy CI), and a new **Phase 10 — connectors & quality regression**.
